...
# Thresholds
DEFAULT_MEMORY_GROWTH_THRESHOLD_PCT=10
if [[ "$(uname)" == "Darwin" ]]; then
    # vm_stat-based memory accounting on macOS is noisier than /proc-based metrics.
    DEFAULT_MEMORY_GROWTH_THRESHOLD_PCT=25
fi
MEMORY_GROWTH_THRESHOLD_PCT="${MEMORY_GROWTH_THRESHOLD_PCT:-$DEFAULT_MEMORY_GROWTH_THRESHOLD_PCT}"
THROUGHPUT_DROP_THRESHOLD_PCT="${THROUGHPUT_DROP_THRESHOLD_PCT:-20}"
