...
| TigerBeetle | ArcherDB | Action |
|-------------|----------|--------|
| `cache_accounts_size_default` | `cache_geo_events_size_default` | Rename/repurpose |
| `cache_transfers_size_default` | Remove | Not needed |
| `cache_transfers_pending_size_default` | Remove | Not needed |
