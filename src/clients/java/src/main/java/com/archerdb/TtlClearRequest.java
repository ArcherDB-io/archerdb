...
public final class TtlClearRequest extends Batch {
     ...
     */
    public TtlClearRequest(final int capacity) {
        super(capacity, Struct.SIZE);
    }

    TtlClearRequest(final ByteBuffer buffer) {
     ...
     */
    byte[] getReserved() {
        return getArray(at(Struct.Reserved), 44);
    }
    ...
    void setReserved(byte[] reserved) {
        ...
        if (reserved.length != 44)
            throw new IllegalArgumentException("Reserved must be 44 bytes long");
