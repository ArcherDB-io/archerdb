...
public final class InsertGeoEventResultBatch extends Batch {
     ...
     */
    public InsertGeoEventResultBatch(final int capacity) {
        super(capacity, Struct.SIZE);
    }

    InsertGeoEventResultBatch(final ByteBuffer buffer) {
    ...
    public InsertGeoEventResult getResult() {
        ...
        return InsertGeoEventResult.fromValue(value);
    }
     ...
     * @throws IllegalStateException if a {@link #isReadOnly() read-only} batch.
     */
    void setResult(final InsertGeoEventResult result) {
