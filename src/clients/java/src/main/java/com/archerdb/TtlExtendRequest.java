...
public final class TtlExtendRequest extends Batch {
     ...
     */
    public TtlExtendRequest(final int capacity) {
        super(capacity, Struct.SIZE);
    }

    TtlExtendRequest(final ByteBuffer buffer) {
     ...
     * @throws IllegalStateException if not at a {@link #isValidPosition valid position}.
     */
    public int getExtendBySeconds() {
        final var value = getUInt32(at(Struct.ExtendBySeconds));
        return value;
    }

    /**
     * @param extendBySeconds
     * @throws IllegalStateException if not at a {@link #isValidPosition valid position}.
     * @throws IllegalStateException if a {@link #isReadOnly() read-only} batch.
     */
