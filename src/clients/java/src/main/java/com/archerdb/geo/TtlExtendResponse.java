// ArcherDB Java Client - TTL Extend Response
 ...
 */
public final class TtlExtendResponse {
    ...
    /**
     * Creates a new TTL extend response.
     *
     ...
     */
    public TtlExtendResponse(UInt128 entityId, int previousTtlSeconds, int newTtlSeconds,
    ...
    public String toString() {
        return String.format("TtlExtendResponse{entityId=%s, previousTtl=%d, newTtl=%d, result=%s}",
