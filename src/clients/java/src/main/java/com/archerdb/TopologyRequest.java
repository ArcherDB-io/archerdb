...
public final class TopologyRequest extends Batch {
     ...
     */
    public TopologyRequest(final int capacity) {
        super(capacity, Struct.SIZE);
    }

    TopologyRequest(final ByteBuffer buffer) {
     ...
     */
    void setReserved(final long reserved) {
