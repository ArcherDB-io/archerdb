...
[automatically batched](https://docs.archerdb.io/coding/requests/#batching-events).
...
```cs
var archerAddress = Environment.GetEnvironmentVariable("ARCHERDB_ADDRESS");
var clusterID = UInt128.Zero;
var addresses = new[] { archerAddress != null ? archerAddress : "3000" };
...
reference](https://docs.archerdb.io/reference/account).
...
[time-based identifiers](https://docs.archerdb.io/coding/data-modeling#archerdb-time-based-identifiers-recommended).
...
reference](https://docs.archerdb.io/reference/account#flags).
...
reference](https://docs.archerdb.io/reference/requests/create_accounts).
...
reference](https://docs.archerdb.io/reference/transfer).
...
reference](https://docs.archerdb.io/reference/requests/create_transfers).
...
the [Transfers
reference](https://docs.archerdb.io/reference/transfer#flags).
...
[`history`](https://docs.archerdb.io/reference/account#flagshistory) set retain
[historical balances](https://docs.archerdb.io/reference/requests/get_account_balances).
